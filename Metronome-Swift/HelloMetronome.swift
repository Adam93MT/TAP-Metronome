...
////    @objc optional func metronomeTicking(_ metronome: HelloMetronome, bar: Int32, beat: Int32)
////}
//
...
//    
//    var tempo: Float32 = 0.0
//    var interval: Float32 = 0.0//60.0 / tempo
...
//    }
////
//    func setTempo(tempo: Float32) {
//        self.tempo = tempo
//
//        self.interval = 60.0 / tempo
//        beatsToScheduleAhead = Int32(GlobalConstants.kTempoChangeResponsivenessSeconds / self.interval)
//        if (beatsToScheduleAhead < 1) { beatsToScheduleAhead = 1 }
//    }
//    
//    func getTempo() -> Float32 {
//        return self.tempo
//    }
//    
//}
